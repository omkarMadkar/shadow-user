      ...
      children: [
        ...
        IntrinsicHeight(
          child: Row(
            ...
            children: [
              // Trust Gauge
              SizedBox(width: 240, child: const TrustGaugeWidget()),
              const SizedBox(width: 16),
              // Sentinel Modules
              Expanded(flex: 5, child: const SentinelStatusCard()),
              const SizedBox(width: 16),
              // Demo Control Panel (replaces Threats in wide layout for demo)
              Expanded(flex: 4, child: const DemoControlPanel()),
            ],
          ),
        ),
        ...
        SizedBox(
          ...
          child: Row(
            ...
            children: [
              Expanded(flex: 5, child: const ThreatOverviewPanel()),
              const SizedBox(width: 16),
              Expanded(flex: 7, child: const EventLogTerminal()),
            ],
          ),
        ),
        const SizedBox(height: 16),
        // Bottom row: Productivity Heatmap (full width)
        const SizedBox(height: 380, child: ProductivityHeatmapWidget()),
      ],
    );
  }
  ...
  Widget _narrowLayout() {
    return Column(
      children: [
        ...
        const SizedBox(height: 16),
        SizedBox(height: 400, child: const EventLogTerminal()),
      ],
    );
  }
}
